  ...
  return (
    <View style={{flex:1, marginHorizontal: 22, padding: 10, }}>
      ...
      style={styles.inputContainer}>
        ...
        <Image source={require("../../assets/images/User_icon.png")} style={styles.image} />
      ...
      <View style={{paddingTop:5}}>
          <Button button_txt={'Register'} backgroundColor={COLORS.purple} color={COLORS.white}/>
    </View>
    ...
    <View style={{flexDirection:'row',alignItems:'center',marginVertical:20,}}>
      ...
      <Text style={{fontSize:14}}> Continue with Accounts</Text>
      <View
        style={{
          flex:1,
          height:1,
    ...
    <View style ={
      {
        ...
        >
            ...
            <Text style={{color:"#D44638",fontWeight:'bold'}}>Google</Text>
        </TouchableOpacity>
